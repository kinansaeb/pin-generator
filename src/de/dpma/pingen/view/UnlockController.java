...
public class UnlockController {
	 ...
	 *         <p>
	 *         In this stage we a in the scene of the UnlockController. Stage is
	 *         the same as scene
	 * @since JavaFX 2.2
	 */
	 ...
	 *         <p>
	 *         The DPMA Direkt Pro Unlock Pin unlocked the crypted file. Only
	 *         with this Unlock Pin you have full access to the file
	 */
	 ...
	 *         and numbers Every Human has a unique FIngerPrint.
	 */
	 ...
	 *         <p>
	 *         The FingerPrint Textfield is the inputbox of the Fingerprint. In
	 *         this field the Fingerprint can be writed in the field.
	 */
	@FXML
	 ...
	 *         <p>
	 *         The PinGenerate Button is the button that need to be clicked to
	 *         generate the UnlockPin.
	 */
	 ...
	 *         <p>
	 *         This TextArea is a firmly defined textfield. In this field the
	 *         UnlockPin will be displayed
	 */
	@FXML
	 ...
	 *         <p>
	 *         This Button is important to get back to the last scence. If you
	 *         click it. It will load you immediatly in the last scene
	 */
	@FXML
	 ...
	 *         <p>
	 *         This button is important to copy the textfield If you click it.
	 *         It copy the text into the clipboard
	 */
	private Button copy;
	 ...
	 * @author AlBacher
	 *         <p>
	 *         If the Backbutton get hit it wil immediatly return you to the
	 *         previous scene
	 *         <p>
	 *         If the Unlock Button is got clicked by mice click it will
	 *         recognize this click. After the click it will load you in the
	 *         previous scene
	 * @Since JavaFX 2.0
	 * @param event
	 */
	 ...
	 * @author AlBacher
	 *         <p>
	 *         This is the generateButton it will generate by Button Click the
	 *         UnlockPin
	 *         <p>
	 *         If the Unlock Button got clicked by mice it will recognize this
	 *         click. After it realize this click it will generate the Pin with
	 *         the Verifier code
	 * @Since JavaFX 2.0
	 * @return It will return the Pin that contains different Letters and
	 *         Numbers into the Textfield
	 * @param event
	 */
	@FXML
